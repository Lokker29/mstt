...
import lb2.util.math.geom.shapes.Circle2D;
import lb2.util.math.geom.shapes.Ellipse2D;
import lb2.util.math.geom.shapes.IGeometric2D;
import lb2.util.math.geom.shapes.Line2D;
import lb2.util.math.geom.shapes.Point2D;
import lb2.util.math.geom.shapes.Polyline2D;
import lb2.util.math.geom.shapes.Rect2D;
import lb2.util.math.geom.shapes.TransformMatrix2D;
