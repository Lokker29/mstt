 ...
 * {@link lb2.search.framework.SearchForActions} and
 * {@link lb2.search.framework.SearchForStates}. Most of the concrete
 ...
 * {@link lb2.search.framework.QueueBasedSearch}. They delegate the work of
 * controlling the actual search to some
 * {@link lb2.search.framework.qsearch.QueueSearch} implementation (called
 ...
 * central {@link lb2.search.framework.NodeFactory} class is used for
