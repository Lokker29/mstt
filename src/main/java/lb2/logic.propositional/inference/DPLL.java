package lb2.logic.propositional.inference;
...
import lb2.logic.propositional.kb.KnowledgeBase;
import lb2.logic.propositional.kb.data.Clause;
import lb2.logic.propositional.kb.data.Literal;
import lb2.logic.propositional.kb.data.Model;
import lb2.logic.propositional.parsing.ast.ComplexSentence;
import lb2.logic.propositional.parsing.ast.Connective;
import lb2.logic.propositional.parsing.ast.PropositionSymbol;
import lb2.logic.propositional.parsing.ast.Sentence;
import lb2.logic.propositional.transformations.ConvertToConjunctionOfClauses;
import lb2.logic.propositional.transformations.SymbolCollector;
import lb2.util.Tasks;
import lb2.util.Util;
import lb2.util.datastructure.Pair;
