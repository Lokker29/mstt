package lb2.agent.impl.aprog;

import java.util.Optional;
import java.util.Set;

import lb2.agent.AgentProgram;
import lb2.agent.Model;
import lb2.agent.impl.DynamicState;
import lb2.agent.impl.aprog.simplerule.Rule;
